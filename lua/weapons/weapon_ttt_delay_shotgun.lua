if SERVER then
   AddCSLuaFile()
   resource.AddFile("materials/VGUI/ttt/icon_delayed_damage_shotgun_64.jpg")
end

DEFINE_BASECLASS "weapon_tttbase"

SWEP.HoldType = "shotgun"
SWEP.PrintName = "Delayed Shotgun"
SWEP.Slot = 6
SWEP.ViewModelFlip = false
SWEP.ViewModelFOV = 54
SWEP.EquipMenuData = {
   type = "item_weapon",
   desc = "Does more damage than a standard shotgun,\n but the damage is delayed"
};
SWEP.Icon = "vgui/ttt/icon_delayed_damage_shotgun_64.jpg"
