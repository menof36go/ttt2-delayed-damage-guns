if SERVER then
   AddCSLuaFile()
   resource.AddFile("materials/VGUI/ttt/icon_delayed_damage_rifle_64.jpg")
end

SWEP.HoldType = "ar2"
SWEP.PrintName = "Delayed Rifle"
SWEP.Slot = 6
SWEP.ViewModelFlip = false
SWEP.ViewModelFOV = 54
SWEP.EquipMenuData = {
   type = "item_weapon",
   desc = "Does more damage than a standard rifle,\n but the damage is delayed"
};
SWEP.Icon = "vgui/ttt/icon_delayed_damage_rifle_64.jpg"
